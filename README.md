...
![Pic 1](https://github.com/ayaakoub/MechaCar_Statistical_Analysis/blob/main/Images/1_lin_reg.PNG)

### Summary of Linear Regression model
A summary of the linear regression can be displayed to determine the quality of the dataset.  In this distribution of the residuals, the dataset fits in with the normal parameters, where the absolute value of the min and max are comparable |-19.47|~|18.58| and the median -.07 is close to zero.

![Pic 2](https://github.com/ayaakoub/MechaCar_Statistical_Analysis/blob/main/Images/2_sum_stat.PNG)
...
![Pic 3](https://github.com/ayaakoub/MechaCar_Statistical_Analysis/blob/main/Images/3_tot_sum.PNG)

### Summary by Manufacturing Lot Number
The means of the lot numbers are similar to the population mean and the sample mean.  

![Pic 4](https://github.com/ayaakoub/MechaCar_Statistical_Analysis/blob/main/Images/4_lot_sum.PNG)
...
![Pic 5](https://github.com/ayaakoub/MechaCar_Statistical_Analysis/blob/main/Images/5_lot_all.PNG)

### T-test for Lot 1
Lot 1: p-value = 1, alpha = .05    
1 > .05, which means Lot 1 is not statistically significant from the normal distribution and normality can be assumed.  The mean falls within the 95% confidence interval.

![Pic 6](https://github.com/ayaakoub/MechaCar_Statistical_Analysis/blob/main/Images/6_lot_1.PNG)
...
![Pic 7](https://github.com/ayaakoub/MechaCar_Statistical_Analysis/blob/main/Images/7_lot_2.PNG)

### T-test for Lot 3
Lot 3: p-value = .04168, alpha = .05   
.04 < .05, which means it is statistically significant from the normal distribution and normality cannot be assumed.  However, the mean falls within the 95% confidence interval.

![Pic 8](https://github.com/ayaakoub/MechaCar_Statistical_Analysis/blob/main/Images/8_lot_3.PNG)
